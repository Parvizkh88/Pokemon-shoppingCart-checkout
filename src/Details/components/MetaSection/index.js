...
const MetaSection = ({id, type, name, price, stats, abilities,image }) => 
  ...
  return (
        <Wrapper>
...

          {
            addToCart 
                ?
                <ValueChanger idPro={id} value={1} ZeroValue={()=> setAddToCart(false)}/>
                :
                <BuyButton onClick={addToCartFunction}>Add to bag</BuyButton>
          }
